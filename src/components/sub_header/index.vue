<template>
    <div class='sub-header'>
        ...
        <div class='home'  v-show="isHome" @click="$router.push('/my')"></div>
...
<style scoped>
    ...
    .sub-header .home{width:0.7rem;height:0.7rem;background-image:url("../../assets/images/home/main/my1.png");background-size:100%;background-repeat: no-repeat;background-position: center;}
